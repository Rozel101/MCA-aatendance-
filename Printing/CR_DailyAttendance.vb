...
Public Class CR_DailyAttendance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCA_AMS.CR_DailyAttendance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DailyAttendance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DailyAttendance = New CR_DailyAttendance()
        rpt.Site = Me.Site
        Return rpt
    End Function
