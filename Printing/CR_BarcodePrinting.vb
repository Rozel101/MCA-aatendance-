...
Public Class CR_BarcodePrinting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCA_AMS.CR_BarcodePrinting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_BarcodePrinting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_BarcodePrinting = New CR_BarcodePrinting()
        rpt.Site = Me.Site
        Return rpt
    End Function
