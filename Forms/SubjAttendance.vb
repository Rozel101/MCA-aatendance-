...
Public Class SubjAttendance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCA_AMS.SubjAttendance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubjAttendance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubjAttendance = New SubjAttendance()
        rpt.Site = Me.Site
        Return rpt
    End Function
